...
HIT_PATH = config["samples_path"]["lsmcache_hit_xgb_final"]
...
for num_sample in [18]:  # 每个工作负载的采样数量，因为工作负载数=FOLD数
    ...
    for train_index, test_index in kf.split(X1):
        ...
        regr1 = xgb.XGBRegressor(learning_rate=0.5, n_estimators=10)
    ...
    for train_index, test_index in kf.split(X2):
        ...
        regr2 = xgb.XGBRegressor(learning_rate=0.5, n_estimators=10)
        # Train the XGBoost cache model
